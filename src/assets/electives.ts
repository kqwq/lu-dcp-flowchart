...
const electives = {
  ...
  "CARP",
    ...
    "communications": ["Communications Elective"],
    "composition": ["Composition Elective"], // Surprisingly only for BA (not BS or AA)
    "informationLiteracy": ["Information Literacy Elective"],
    "math114OrHigher": ["Math Elective"],
    "technologyCompetency": ["Technology Competency"],
    "criticalThinking": ["Critical Thinking Elective"],
    "STEM": ["CSIS","ENGR","ENVR","PHSC","PHYS2XX","MATH2XX","STEM2XX"],
    "language": ["Language Elective"],
    "integrative": ["Integrative Elective"],
    "english": ["English Elective", "ENGL3XX"],
    "literature": ["Literature Elective", c.ENGL201,c.ENGL202,c.ENGL215,c.ENGL216,c.ENGL221,c.ENGL222],
    
    culturalStudies: ["Cultural Studies Elective"],
    naturalScience: ["Natural Science Elective"],
    socialScience: ["Social Science Elective"],
